...
if __name__ == "__main__":
    ...
    with open('/home/juliohsu/Desktop/dev/beats/beat_this/beat_this/custom_vqt/inferece_beats_from_test/beat_jazz_beat_cqt_512.txt', 'w') as f:
        f.write('\n'.join(map(str, beat.tolist())))
        
    with open('/home/juliohsu/Desktop/dev/beats/beat_this/beat_this/custom_vqt/inferece_beats_from_test/beat_jazz_downbeat_cqt_512.txt', 'w') as f:
